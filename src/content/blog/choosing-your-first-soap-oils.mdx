...
- **Beeswax** — extremely slow trace, finicky temperatures (kept at 3% it's manageable — see the [Honey & Beeswax Bar](/tools/soap-calculator/recipes/honey-beeswax-bar) for a beginner-safe formula)
...
- **[Free Recipe Library](/tools/soap-calculator/recipes)** — 18 vetted recipes from beginner balanced bars to specialty formulations
- **[Solid Dish Soap Bar](/tools/soap-calculator/recipes/solid-dish-soap)** — high-coconut cleaning bar that replaces bottled dish liquid
- **[Annatto Natural Orange](/tools/soap-calculator/recipes/annatto-natural-orange)** — natural plant-based colour without micas or oxides
